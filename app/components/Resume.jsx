...
const Resume = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center lg:gap-10 gap-5 my-8">
      {/* Left Side */}
      ...
      <div className="hidden md:flex flex-col items-center relative h-[420px] w-16">
      ...
      {/* Right Side */}
      <div className="w-full md:w-[45%] p-6 bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-xl backdrop-blur-md border border-blue-100 dark:border-emerald-900">
